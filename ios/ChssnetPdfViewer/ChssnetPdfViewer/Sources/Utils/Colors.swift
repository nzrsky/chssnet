...
class Colors {
    ...
    var colorsTable: [Int: [UIColor]] {
        [0: red, 1: orangeRed, 2: orange, 3: yellow, 4: green, 5: greenBlue, 6: kindaBlue,
         7: skyBlue, 8: blue, 9: bluePurple, 10: bluePurple, 11: purple, 12: pink]
    }
    
    var randomColors: [UIColor] {
        colorsTable.values.randomElement()!
    }
}
